...
using Acme.Net.Microservice.Clients.gRpc.Services;
...
builder.Services.AddMongo<Acme.Net.Microservice.Clients.Infrastructure.Startup>(builder.Configuration);
builder.Services.AddRedis(builder.Configuration);
builder.Services.AddRabbitMQ<Acme.Net.Microservice.Clients.Domain.Startup>(builder.Configuration);
